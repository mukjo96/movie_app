...
class TopRated7 extends React.Component {
  state = {
    isLoading: true,
    movies: [],
  };
  ...
  getMovies = async () => {
    const {
      ...
      `https://api.themoviedb.org/3/movie/top_rated?api_key=cfaaa8c5177462f54ee54a30c746dca3&language=ko-KR&page=7&region=KR`
    );
      ...
      <body className="container">
        <nav className="PageNavigation">
          <ul className="pagination">
            ...
            <li className="page-item">
              <a className="page-linkh" href="#/toprated/7">
                7
              </a>
            </li>
            <li className="page-item">
